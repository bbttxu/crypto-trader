...
normalizeStatInputs = require './normalizeStatInputs'
...
normalizeStatsInputs = ( stats )->
  getOutput = ( product )->
    normalizeStatInputs stats[ product ]

  join map getOutput, keys( stats ).sort()
...
module.exports = normalizeStatsInputs
