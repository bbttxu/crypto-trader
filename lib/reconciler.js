...
const { min, equals } = require("sanctuary");

const { uniq, gt } = require("ramda");
...
const toFixed = (size = 0) => size.toFixed(8);

const reconciler = (buy, sell) => {
  let value = 0;
